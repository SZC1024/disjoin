#ifndef SlaveSPARQLParser_H_
#define SlaveSPARQLParser_H_
//---------------------------------------------------------------------------
// RDF-3X
...
//---------------------------------------------------------------------------
class SlaveSPARQLLexer;

//---------------------------------------------------------------------------
/// A parser for SPARQL input
class SlaveSPARQLParser {
public:
	/// A parsing exception
...
public:
	/// Constructor
	explicit SlaveSPARQLParser(SlaveSPARQLLexer &lexer);
	...
	/// Get the patterns
	PatternGroup &getPatterns() { return patterns; }
	...
	std::vector<unsigned> &getProjection() {
		return projection;
	}
	
	std::map<std::string, unsigned> &getNamedVariables() {
