...
//---------------------------------------------------------------------------
SlaveSPARQLLexer::SlaveSPARQLLexer(const std::string &input) :
...
//---------------------------------------------------------------------------
SlaveSPARQLLexer::~SlaveSPARQLLexer()
// Destructor
{
}

//---------------------------------------------------------------------------
SlaveSPARQLLexer::Token SlaveSPARQLLexer::getNext()
// Get the next token
{
...
//---------------------------------------------------------------------------
std::string SlaveSPARQLLexer::getTokenValue() const
...
//---------------------------------------------------------------------------
bool SlaveSPARQLLexer::isKeyword(const char *keyword) const
