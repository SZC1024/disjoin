...
//获取查询语句vec
vector<string> subQuery::getQueryVec() const{
    
    return queryStrVec;
}

//获取查询变量个数
size_t subQuery::getQueryValNum() const{
    
    return queryValNum;
}
 
//获取变量名
vector<string> subQuery::getValNameVec() const{
    
    return valNameVec;
}

//获取结果值
size_t subQuery::getCount() const{
    
    return resultCount;
}

//获取ID
size_t subQuery::getID() const{
    
    return ID;
}

//获取类型
int subQuery::getType() const{
    
    return type;
}

//获取左父ID
size_t subQuery::getParentLeft() const{
    
    return parentIDLeft;
}

//获取右父ID
size_t subQuery::getpParentRight() const{
